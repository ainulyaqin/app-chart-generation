...
public class APIChartController {
	...
	@PostMapping("/api/v1/render-html")
	public ResponseData renderHtml(@RequestBody RenderHtmlDto renderHtmlDto) throws JsonProcessingException {
		return APIChartService.renderHtml(renderHtmlDto);
	}
}
